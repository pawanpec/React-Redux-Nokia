...
2. **Clone this repository.** - `git clone https://github.com/pawanpec/React-Redux-Nokia.git` or [download the zip](https://github.com/pawanpec/React-Redux-Nokia/archive/master.zip)
